...
public class PullToRefreshLoadingLayout extends FrameLayout {
	...
	public PullToRefreshLoadingLayout(Context context, final int mode,
		...
		case PullToRefreshBase.MODE_PULL_UP_TO_REFRESH:
			headerImage.setImageResource(R.drawable.readmode_scroll_arrow_up);
			break;
		case PullToRefreshBase.MODE_PULL_DOWN_TO_REFRESH:
		default:
			headerImage.setImageResource(R.drawable.readmode_scroll_arrow_down);
			break;
		}
	}
